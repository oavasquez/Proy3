...
class LeerColores():
	...
	def leer_imagen(self, ruta):
		...
		return arreglo
		#self.colorActualFloodIt(arreglo)
	...
	'''
		FALTAN CAMBIOS
		Esta funciOn deberIa devolver el color actual del flood it en entero, 
		recibe el arreglo proveniente de la captura de pantalla
	'''
	def color_actual_flood_it(self, arreglo):
		ArregloCantPixel=[]
	...
	'''
		Esta funciOn devuelve el tablero de 2048 en un arreglo de 16 elementos, 
		recibe el arreglo proveniente de la captura de pantalla
	'''
	def tablero_2048(self, arreglo):
		ArregloCantPixel=[]
		#print  "tamano de pantalla en x:"+str(len(arreglo))
		#print  "tamano de pantalla en y:"+str(len(arreglo[0]))
		...
		for arregloNum in arregloContenedorNum:
			vectorTablero.append(self.BuscarNumero(arregloNum))
