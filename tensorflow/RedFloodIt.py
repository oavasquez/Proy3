...
class RedFloodIt:
	...
	'''
		ATENCION: falta definir el modelo de Flood It el cual es una matriz la cual deberia de 
		tener como entrada un vector de n x n
		y deberia tener una salida del color que se debe seleccionar. 
		Mediante ese color se busca en el pantallazo las coordenadas luego para darle click
	'''
